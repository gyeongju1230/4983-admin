...
export const Chats = () => {
  const SEARCH_OPTIONS = [
    {value: "1", name: "구매 요청", color: "#225510", backgroundColor: "#E3F9DC"},
    {value: "2", name: "구매 수락(입금확인필)", color: "#225510", backgroundColor: "#E3F9DC"},
    {value: "3", name: "입금 확인 완료", color: "#D2A225", backgroundColor: "#F9F6DC"},
    {value: "4", name: "서적 배치 완료", color: "#A70D0D", backgroundColor: "#F9DCDC"},
    {value: "5", name: "거래 완료", color: "#A70D0D", backgroundColor: "#F9DCDC"},
    {value: "999", name: "거래 거절", color: "#A70D0D", backgroundColor: "#F9DCDC"},
    {value: "1000", name: "판매자 거래 중지", color: "#55584A", backgroundColor: "#D1D1CD"},
    {value: "1001", name: "구매자 거래 중지", color: "#55584A", backgroundColor: "#D1D1CD"},
          ...
          {chatList.map((value) => (
            <styles.BodyTr>
              <styles.BodyTd
                ...
                }>{value.sellerStudentId}</styles.BodyTd>
              <styles.BodyTd>
                {SEARCH_OPTIONS.find((searchOption) => searchOption.value === String(value.interact)) && (
                  <styles.ChatStatusDiv>{SEARCH_OPTIONS.find((searchOption) => searchOption.value === String(value.interact)).name}</styles.ChatStatusDiv>
                )}
              </styles.BodyTd>
              ...
              <styles.BodyTd
                ...
                }>{value.buyerStudentId}</styles.BodyTd>
