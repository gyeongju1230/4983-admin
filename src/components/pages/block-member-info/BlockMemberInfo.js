import * as styles from "./BlockMemberInfo.style";
...
export const BlockMemberInfo = () => {
  ...
  useEffect(() => {
    ...
    BASE_API.get("/api/v1/admin/member/block", {
      params,
      ...
      .then(() => {
        // window.document.getElementById("searchKeyword").value =
        //   searchKeyword;
